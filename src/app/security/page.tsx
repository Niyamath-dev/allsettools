...
export default function SecurityPage() {
  const jsonLdGraph = {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://allsettools.com/security#webpage",
        "url": "https://allsettools.com/security",
        ...
        "breadcrumb": {
          "@id": "https://allsettools.com/security#breadcrumb"
        }
      },
      {
        "@type": "BreadcrumbList",
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Security Policy",
            "item": "https://allsettools.com/security"
          }
        ]
      }
    ]
